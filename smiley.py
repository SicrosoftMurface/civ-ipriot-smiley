...
class Smiley:
    ...
    # Add complexion=YELLOW to the method __init__()
        # We have encapsulated the SenseHat object
        self.sense_hat = SenseHat()
        self.my_complexion = complexion
        # Create a new instance variable called my_complexion and assign complexion to it

        Y = complexion  # assign complexion to Y
        O = self.BLANK
        self.pixels = [
            O, Y, Y, Y, Y, Y, Y, O,
            Y, Y, Y, Y, Y, Y, Y, Y,
